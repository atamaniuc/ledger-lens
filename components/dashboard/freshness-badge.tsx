...
import { formatAge } from "@/lib/dashboard/freshness";
import type { QueryResult } from "@/lib/dashboard/queries";
...
export function FreshnessBadge({ result }: { result: QueryResult<Freshness> }) {
  if (!result.ok) {
    return (
